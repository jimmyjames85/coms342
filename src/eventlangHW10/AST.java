...
public interface AST
{
	...
	public static class WhenExp extends Exp
	{
		...
		public WhenExp(Exp event, Exp body, Exp priority)
		{
			_event = event;
			_body = body;
			_priority = priority;
	...
	public static class UnregisterExp extends Exp
	{
		
		Exp _event ;
		Exp _priority;
		
		public UnregisterExp(Exp event, Exp priority)
		{
			_event = event;
			_priority = priority;
		}
	...
	public static class AnnounceExp extends Exp
	{
		Exp _event;
		List<Exp> _actuals;
		boolean priorityIsHigh = false;
		
		public AnnounceExp(Exp event, List<Exp> actuals, boolean priorityIsHigh)
		{
			_event = event;
			_actuals = actuals;
			this.priorityIsHigh = priorityIsHigh;
		}
	...
	public interface Visitor<T>
	{
		...
		public T visit(AST.UnregisterExp e, Env env);
	}
}

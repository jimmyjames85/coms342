...
public interface Env
{
	...
	List<Integer> reachableList(Heap heap);
	...
	static public class EmptyEnv implements Env
	{
		...
		public List<Integer> reachableList(Heap heap)
		{
	...
	static public class ExtendEnv implements Env
	{
		...
		public List<Integer> reachableList(Heap heap)
		{
			List<Integer> ret = _saved_env.reachableList(heap);
			ret.addAll(_val.reachable(heap));
			return ret;
		}
	}

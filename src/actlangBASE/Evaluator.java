package actlang;
import static actlang.AST.*;
import static actlang.Heap.*;
import static actlang.Value.*;
...
public class Evaluator implements Visitor<Value> {
	...
	@Override
	public Value visit(Unit e, Env env, Heap h) {
		return new UnitVal();
	}

	@Override
	public Value visit(Const e, Env env, Heap h) {
		return new NumVal(e.v());
	}

	@Override
	public Value visit(StrConst e, Env env, Heap h) {
		return new StringVal(e.v());
	}

	@Override
	public Value visit(BoolConst e, Env env, Heap h) {
	...
	@Override
	public Value visit(ListExp e, Env env, Heap h) { // New for funclang.
		...
		for(Exp exp : elemExps) 
			elems.add((Value) exp.accept(this, env, h));

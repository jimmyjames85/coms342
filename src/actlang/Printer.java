...
public class Printer
{
	...
	public static class Formatter implements AST.Visitor<String>
	{
		...
		public String visit(AST.Unit e, Env env, Heap h)
		{
			return "unit";
		}

		public String visit(AST.Const e, Env env, Heap h)
		{
			return "" + e.v();
		}

		public String visit(AST.StrConst e, Env env, Heap h)
		{
			return e.v();
		}

		public String visit(AST.BoolConst e, Env env, Heap h)
		{
			if (e.v())
				return "#t";
			return "#f";
		...
		@Override
		public String visit(ActorExp e, Env env, Heap h)
		{
			String result = "(actor ( ";
			for (String formal : e.formals())
				result += formal + " ";
		...
		{
			String result = "(send ";
			result += e.actor().accept(this, env, h);
			for (Exp actual : e.actuals())
				result += actual.accept(this, env, h) + " ";
			return result + ")";
		}

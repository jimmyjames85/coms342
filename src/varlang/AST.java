...
public interface AST
{
	...
	public static abstract class Exp extends ASTNode
	{
		...
		public boolean isBound(String varName)
		{
			return boundVars.contains(varName);
		};
	...
	public static class LetExp extends Exp
	{
		...
		public LetExp(List<String> names, List<Exp> value_exps, Exp body)
		{
			...
			{
				this.boundVars.add(varName);
				body.boundVars.add(varName);
				for(Exp e: _value_exps)
				{
					e.boundVars.add(varName);
				}
			}

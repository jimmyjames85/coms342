...
public interface Value {
	...
	static class FunVal implements Value { //New in the funclang
		...
		private Exp _body;
		private Exp _default;
		
		public FunVal(Env env, List<String> formals, Exp body, Exp defaultExp) 
		{
			_env = env;
			_formals = formals;
			_body = body;
		...
		public Exp defaultExp() { return _default; }		
		...
		public String tostring() { 
			...
			result += _default.accept(new Printer.Formatter(), _env);
			result += ") ";

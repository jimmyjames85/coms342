...
public interface AST
{
	...
	public static class LambdaExp extends Exp
	{
		...
		public LambdaExp(List<String> formals, Exp body, Exp defaultExp)
		{
			_formals = formals;
			_body = body;
			_default = defaultExp;
	...
	public static class FreqExp extends Exp
	{
		private Exp _loc_exp;

		public FreqExp(Exp loc_exp)
		{
			_loc_exp = loc_exp;
		}
	...
	public interface Visitor<T>
	{
		...
		public T visit(AST.FreqExp e, Env env); 		

...
public class Printer
{
	...
	public static class Formatter implements AST.Visitor<String>
	{
		...
		public String visit(AST.NumQExp e, Env env)
		{
		...
		public String visit(AST.BoolQExp e, Env env)
		{
		...
		public String visit(AST.StringQExp e, Env env)
		{
		...
		public String visit(AST.ProcedureQExp e, Env env)
		{
		...
		public String visit(AST.PairQExp e, Env env)
		{
			String result = "(pair? ";
			result += e.arg().accept(this, env);
			return result + ")";			
		...
		public String visit(AST.ListQExp e, Env env)
		{
			String result = "(list? ";
			result += e.arg().accept(this, env);
			return result + ")";
		...
		public String visit(AST.NullQExp e, Env env)
		{
			String result = "(null? ";
			result += e.arg().accept(this, env);
			return result + ")";
		...
		public String visit(AST.UnitQExp e, Env env)
		{
			String result = "(unit? ";
			result += e.arg().accept(this, env);
			return result + ")";

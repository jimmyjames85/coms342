...
public interface AST
{
	...
	public static class NumQExp extends Exp
	{
		private Exp _arg;

		public NumQExp(Exp arg)
		{
			_arg = arg;
		}
	...
	public static class BoolQExp extends Exp
	{
		private Exp _arg;

		public BoolQExp(Exp arg)
		{
			_arg = arg;
		}
	...
	public static class StringQExp extends Exp
	{
		private Exp _arg;

		public StringQExp(Exp arg)
		{
			_arg = arg;
		}
	...
	public static class ProcedureQExp extends Exp
	{
		private Exp _arg;

		public ProcedureQExp(Exp arg)
		{
			_arg = arg;
		}
	...
	public static class PairQExp extends Exp
	{
		private Exp _arg;

		public PairQExp(Exp arg)
		{
			_arg = arg;
		}
	...
	public static class ListQExp extends Exp
	{
		private Exp _arg;

		public ListQExp(Exp arg)
		{
			_arg = arg;
		}
	...
	public static class NullQExp extends Exp
	{
		private Exp _arg;

		public NullQExp(Exp arg)
		{
			_arg = arg;
		}
	...
	public static class UnitQExp extends Exp
	{
		private Exp _arg;

		public UnitQExp(Exp arg)
		{
			_arg = arg;
		}
	...
	public interface Visitor<T>
	{
		...
		public T visit(AST.ReadExp e, Env env); // New for the funclangHw5

		public T visit(AST.EvalExp e, Env env); // New for the funclangHw5

		public T visit(AST.LambdaExp e, Env env); // New for the funclangHw5

		public T visit(AST.CallExp e, Env env); // New for the funclangHw5
		...
		public T visit(AST.NumQExp e, Env env);
		
		public T visit(AST.BoolQExp e, Env env);

		public T visit(AST.StringQExp e, Env env);

		public T visit(AST.ProcedureQExp e, Env env);

		public T visit(AST.PairQExp e, Env env);

		public T visit(AST.ListQExp e, Env env);

		public T visit(AST.NullQExp e, Env env);

		public T visit(AST.UnitQExp e, Env env);

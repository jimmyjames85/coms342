...
public interface AST
{
	...
	public static class RarithExp extends Exp
	{
		private Exp _value_exp;

		public RarithExp(Exp value_exp)
		{
			_value_exp = value_exp;
		}
	...
	public static class ReachableExp extends Exp
	{
		private Exp _value_exp;

		public ReachableExp(Exp value_exp)
		{
			_value_exp = value_exp;
		}
	...
	public interface Visitor<T>
	{
		...
		public T visit(AST.RarithExp e, Env env); // New for the Reflang

		public T visit(AST.ReachableExp e, Env env); // New for the Reflang		
	}
}

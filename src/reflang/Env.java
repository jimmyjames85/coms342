...
public interface Env
{
	...
	{
		public RefVal get(String search_var)
		{
	...
	static public class ExtendEnv implements Env
	{
		...
		public ExtendEnv(Env saved_env, String var, RefVal val)
		{
		...
		public synchronized RefVal get(String search_var)
		{
			if (search_var.equals(_var))
				return new RefVal(_refLoc);
	...
	static public class ExtendEnvRec implements Env
	{
		...
		private Heap recHeap = new Heap.Heap16Bit();
		...
		public RefVal get(String search_var)
		{
			...
			for (int index = 0; index < size; index++)
			{
				if (search_var.equals(_names.get(index)))
				{
					...
					return (RefVal)recHeap.ref((new Value.FunVal(this, f.formals(), f.body())));

	...
	public static class Formatter implements AST.Visitor<String> {
		...
		public String visit(AST.LetrecExp e, Env env) {
			...
			return result + ")";
				...
				public String visit(AST.SignalExp e, Env env) {
                    String result = "(signal ";
                    result += e.value_exp().accept(this, env);
                    return result + ")";
				}

				public String visit(AST.ReadSigExp e, Env env) {
                    String result = "(read ";
                    result += e.signal_exp().accept(this, env);
                    return result + ")";
				}

				public String visit(AST.WriteSigExp e, Env env) {
                    String result = "(write ";
                    result += e.signal_exp().accept(this, env);
                    result += " ";

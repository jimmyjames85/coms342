...
public interface AST {
    ...
    public static class ReadSigExp extends Exp {
        private Exp _signal_exp;

        public ReadSigExp(Exp signal_exp) {
        	_signal_exp = signal_exp;
        }
        ...
        public Exp signal_exp() { return _signal_exp; }

    }

    public static class WriteSigExp extends Exp {
        private Exp _signal_exp;
        private Exp _val_exp;

        public WriteSigExp(Exp signal_exp, Exp val_exp) {
        	_signal_exp = signal_exp;
        	_val_exp = val_exp;
        }
        ...
        public Exp signal_exp() { return _signal_exp; }
        public Exp val_exp() { return _val_exp; }

    }

    
	public static class SignalExp extends Exp {
        private Exp _value_exp;

        public SignalExp(Exp value_exp) {
                _value_exp = value_exp;
        }
	...
	public interface Visitor <T> {
		...
		public T visit(AST.EventExp e, Env env); 
		public T visit(AST.AnnounceExp e, Env env); 
		public T visit(AST.WhenExp e, Env env);
		
		public T visit(AST.SignalExp e, Env env);
		public T visit(AST.ReadSigExp e, Env env);
		public T visit(AST.WriteSigExp e, Env env);
